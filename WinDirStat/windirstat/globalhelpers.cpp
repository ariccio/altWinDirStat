...
void Children_String_Heap_Manager::reset( const rsize_t number_of_characters_needed ) {
	m_buffer_filled = 0u;
	m_string_buffer.reset( new wchar_t[ number_of_characters_needed ] );
	m_buffer_size = number_of_characters_needed;
	}

Children_String_Heap_Manager::Children_String_Heap_Manager( ) : m_buffer_size { 0u }, m_buffer_filled { 0u }, m_string_buffer { nullptr } { }
