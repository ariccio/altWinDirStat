...
public:
	CDriveItem ( CDrivesList *list, _In_z_ LPCTSTR pszPath ) : m_list( list ), m_path( pszPath ), m_name( m_path ), m_success( false ), m_totalBytes( 0 ), m_freeBytes( 0 ), m_used( 0 ), m_querying( true ), m_isRemote( DRIVE_REMOTE == GetDriveType( m_path ) ) { }
